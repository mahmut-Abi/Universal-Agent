...
def main() -> None:
    with TemporaryDirectory(prefix="universal-agent-sqlite-workers-") as directory:
        workers_path = Path(directory) / "workers.sqlite3"
        ...
        print(f"workers_db={workers_path.exists()}")
