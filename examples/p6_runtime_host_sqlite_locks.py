...
def main() -> None:
    with TemporaryDirectory(prefix="universal-agent-sqlite-locks-") as directory:
        locks_path = Path(directory) / "distributed-locks.sqlite3"
        ...
        print(f"locks_db={locks_path.exists()}")
