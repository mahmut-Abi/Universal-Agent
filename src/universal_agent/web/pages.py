...
from universal_agent.web.catalog_sections import (
    _capabilities,
    _configured_domains,
    _domain_details,
...
from universal_agent.web.heroes import (
    _catalog_hero,
    _distributed_hero,
    _doctor_hero,
    _domain_hero,
...
from universal_agent.web.operational_sections import (
...
from universal_agent.web.session_sections import (
    _audit,
    _events,
    _selected_session,
    _sessions,
